export default {
  ...
  roomDiscovery: {
    title: "部屋",
    refresh: "更新",
    physicalLanTab: "物理LAN",
    virtualLanTab: "仮想LAN",
    relayTab: "サーバー",
    physicalLanDesc: "同じ物理 LAN 内で待機中の BZ-Games 部屋を自動検索します。仮想 LAN の部屋は表示せず、参加前にゲーム ID とバージョンを確認します。",
    virtualLanDesc: "EasyTier、ZeroTier、Tailscale、WireGuard など、仮想ネットワークアダプター経由で相互接続された仮想 LAN の部屋を表示します。",
    relayDesc: "サーバー部屋は公式リレーサービスから取得します。ホストが公式サーバーモードを有効にすると短縮アドレスが表示され、ゲストは直接参加できます。",
    emptyPhysicalLan: "参加可能な物理 LAN 部屋はありません",
    emptyVirtualLan: "参加可能な仮想 LAN 部屋はありません",
