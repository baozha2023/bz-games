export default {
  ...
  room: {
    ...
    lanGuideEasyTierStep2: "创建或加入同一个虚拟网络，网络名称与网络密钥需要保持一致；如果使用初始节点，请填写 tcp 39.106.221.85:11010，这个节点由 BZ-Games 官方提供。",
  ...
  roomDiscovery: {
    title: "房间",
    refresh: "刷新",
    physicalLanTab: "物理局域网",
    virtualLanTab: "虚拟局域网",
    relayTab: "服务器",
    physicalLanDesc: "自动扫描同一物理局域网内正在等待的 BZ-Games 房间，不显示虚拟局域网房间，加入前会校验游戏 ID 与版本。",
    virtualLanDesc: "显示通过虚拟网卡互通的虚拟局域网房间，例如 EasyTier、ZeroTier、Tailscale、WireGuard 等虚拟组网环境中的房间。",
    relayDesc: "服务器房间来自官方中继服务端，房主开启服务器模式后会显示短地址，客机可直接加入。",
    emptyPhysicalLan: "暂无可加入的物理局域网房间",
    emptyVirtualLan: "暂无可加入的虚拟局域网房间",
  ...
  settings: {
    ...
    cloudErrors: {
      ...
      cloud_sync_rate_limited: "云同步过于频繁，同一账号上传和下载各自每小时只能执行一次",
      unknown: "云同步失败",
    },
    closeBehavior: "关闭主窗口",
    closeToTray: "最小化托盘",
