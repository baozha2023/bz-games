...
export default {
  ...
  social: {
    ...
    loadFailed: "Failed to load the forum",
    ...
    postBody: "Content",
    postBodyPlaceholder: "Share your thoughts",
    insertGame: "Insert game",
    marketCandidate: "Market",
    selectedMarket: "Market: {market}",
    clearMarket: "Clear market filter",
    noGameMatches: "No matching market or game",
    gameMentionHint: "Select a candidate to create a game tag",
    gameMentionLoading: "Resolving game",
    unknownGame: "Unknown game",
    bodyTooLong: "Content is too long",
    ...
    errors: {
      unauthorized: "Please sign in to use the forum",
      session_expired: "Your sign-in session expired",
      session_invalid: "Your sign-in session is invalid",
      search_unavailable: "Search is temporarily unavailable",
      forum_not_configured: "Forum is not configured",
      ...
      image_too_large: "Images must be at most 5 MiB",
      too_many_images: "Up to 4 images can be attached",
      invalid_image: "Invalid image file",
      duplicate_image: "The same image cannot be added twice",
      image_storage_not_configured: "Image storage is not configured",
      image_failed: "Failed to read the image",
      forum_image_load_failed: "Failed to load the image",
      forum_load_failed: "Failed to load the forum",
    },
  },
  feedback: {
    button: "Feedback",
  ...
  library: {
    ...
    importTask: {
      ...
      retry: "Retry",
      remove: "Remove",
      working: "Preparing game",
      ready: "Game ready",
      attention: "Needs your attention",
      filesFound: "{count} files found",
      localImport: "Copying to your library",
      marketInstall: "Finishing market installation",
      status: {
        queued: "Waiting to import",
        validating: "Validating",
        scanning: "Scanning files",
        copying: "Importing",
        finalizing: "Updating library",
    ...
    importError: {
      ...
      symbolicLinkUnsupported: "Symbolic links are not supported: {file}",
      webUrlInvalid:
  ...
  marketList: {
    ...
    gameHostingOpenFailed:
      "Unable to open game hosting. Please try again later.",
  },
  market: {
    title: "Game Market",
    refresh: "Refresh",
    refreshGames: "Refresh Games",
    sourceInfo: "Market Source Info",
    retry: "Retry",
  ...
  gameDetail: {
    ...
    launchFailed: "Failed to launch the game. Check the error log for details",
  ...
  room: {
    ...
    launchError: {
      ...
      entryNotFound: "Entry file not found: {entry}",
      webUrlMissing: "The URL game is missing web_url",
      processLaunchFailed: "Failed to launch the game process: {detail}",
      unknown: "Unknown launch error: {detail}",
    },
  ...
  checkIn: {
    ...
    maxStreak: "Best streak {days} days",
    day: "Day {day}",
    action: "Check in",
    checked: "Checked in",
  ...
  settings: {
    ...
    dataHealthIssue: {
      config_missing: "config.json does not exist",
  ...
  statistics: {
    ...
    shareHeatmap: "Share",
    shareTotalDays: "Total Play Days",
    shareLongestStreak: "Longest Streak",
    shareTotalHours: "Total Play Hours",
    shareMaxDailyHours: "Longest Day",
    shareNotLoggedIn: "Not logged in",
  },
  achievement: {
    title: "Achievements",
  ...
  personalization: {
    ...
    unlockDatePlaytime: "Play for {duration} on {date} to unlock",
    ...
    insufficientCoins: "Not enough BZ Coins",
    conditionNotMet: "The unlock condition has not been met",
    alreadyOwned: "Already owned",
    unlockProgress: "Progress: {current} / {required}",
    ...
    effectHologram: "Holographic Shift",
    effectInkflow: "Ink Flow",
    effectEclipse: "Eclipse Halo",
