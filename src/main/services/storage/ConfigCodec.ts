...
const settingsSchema = z
  .object({
    ...
    cloudSessionToken: z.string().optional(),
    cloudSessionExpiresAt: z.string().optional(),
    cloudUserLogin: z.string().optional(),
    cloudUserName: z.string().optional(),
    cloudUserProfileUrl: z.string().optional(),
    cloudLastUploadedAt: z.string().optional(),
    nicknameStyle: nicknameStyleSchema.optional(),
    libraryLayout: z.enum(["card", "icon", "steam"]).optional(),
    lastJoinRoomAddress: z.string().optional(),
    ...
    chatWindowBounds: z
      ...
      .strict()
      .optional(),
    chatInputHeight: z.number().finite().positive().optional(),
    downloadFloatBall: z.boolean().optional(),
