...
export class GameEnvironment {
    static prepare(id: string, manifest: GameManifest, port: number, token: string, settings: AppSettings): NodeJS.ProcessEnv {
    ...
    static writeConfig(versionPath: string, port: number, token: string, settings: AppSettings): void {
        try {
